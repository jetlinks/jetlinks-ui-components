...
import { TableSummary, TableSummaryRow, TableSummaryCell } from 'ant-design-vue/lib/table/index';
...
export const JTableColumnGroup = withInstall(TableColumnGroup, 'JTableColumnGroup');
export const JTableSummary = withInstall(TableSummary, 'JTableSummary');
export const JTableSummaryRow = withInstall(TableSummaryRow, 'JTableSummaryRow');
export const JTableSummaryCell = withInstall(TableSummaryCell, 'JTableSummaryCell');
