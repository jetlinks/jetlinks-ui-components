...
<template>
  ...
  >
    <j-form-item has-feedback label="Password" name="pass">
      <j-input v-model:value="formState.pass" type="password" autocomplete="off" />
    </j-form-item>
    <j-form-item has-feedback label="Confirm" name="checkPass">
      <j-input v-model:value="formState.checkPass" type="password" autocomplete="off" />
    </j-form-item>
    <j-form-item has-feedback label="Age" name="age">
      <j-input-number v-model:value="formState.age" />
    </j-form-item>
