    ...
    <template #content>
      <Form :model="formData" layout="vertical">
        <FormItem label="文件类型" required :rules="rules">
          <j-radio-group v-model:value="formData.file" button-style="solid">
            <j-space>
              <j-radio-button value="url">URL</j-radio-button>
              <j-radio-button value="base64">Base64</j-radio-button>
              <j-radio-button value="binary">binary</j-radio-button>
            </j-space>
          </j-radio-group>
        </FormItem>
      </Form>
